...
// (We keep lazy import even though we removed embedded version — used in floating chat)
    ...
    >
        ...
        <div className="flex items-center justify-between gap-6">
          <div>
            ...
            <p className="mt-2 text-indigo-100 max-w-2xl">
              Your personalized learning engine is ready. Continue where you left
              off or ask your AI Career Mentor for a custom plan.
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          {/* Persona Card */}
          <motion.div
            className="bg-white dark:bg-gray-900 border p-6 rounded-2xl shadow-lg"
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <motion.div className="bg-white dark:bg-gray-900 border p-4 rounded-2xl shadow">
              ...
              {hasCertificationAccess ? (
                ...
                <Link
                  ...
                  className="inline-block mt-2 px-3 py-1 bg-indigo-600 text-white rounded"
                >
            ...
            <motion.div className="bg-white dark:bg-gray-900 border p-4 rounded-2xl shadow">
              ...
              <Link
                to="/cloud"
                className="inline-block px-3 py-1 bg-indigo-600 text-white rounded"
              >
                Open Cloud Console
              </Link>
            </motion.div>
